...
if not os.path.exists(reference_audio):
    audio_file = os.path.join(SCRIPT_DIR, "assets", "vixtts_sample_female.wav")
else:
    audio_file = run_tts(
        vixtts_model,
